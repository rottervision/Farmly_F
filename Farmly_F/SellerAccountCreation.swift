            ...
            ZStack {
                ...
                ScrollView {
                    VStack {
                        ...
                        Group{
                        Text("Name:")
                        TextField("John Doe", text: $sell_name).textFieldStyle(.roundedBorder).padding()
                        Text("Shop Name (and screen name):")
                        TextField("John's Shop", text: $sell_shop).textFieldStyle(.roundedBorder).padding()
                        Text("Email:")
                        TextField("John.doe@email.com", text: $sell_email).textFieldStyle(.roundedBorder).padding()
                        }
                        
                        Group{
                        Text("Phone (Optional):")
                        TextField("248 123 4567", text: $sell_phone).textFieldStyle(.roundedBorder).padding()
                            Divider()
                        ...
                        Picker(selection: $sell_city, label: Text("sellCityPicker")) {
                            ...
                            Divider()
                        Text("Address:")
                        TextField("1234 Hemmingway St", text: $sell_address).textFieldStyle(.roundedBorder).padding()
                        }
                        ...
                        Group{
                            ...
                            TextField("1A", text: $sell_market_stall).textFieldStyle(.roundedBorder).padding() }
